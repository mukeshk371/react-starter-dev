...
import { Navbar, Container, Nav, Form, FormControl, Button, Dropdown, Table } from "react-bootstrap";
import { Cart, Cart3, DashLg, PersonCircle, PlusLg } from "react-bootstrap-icons";
import { Link } from "react-router-dom";
import logo from "../../../logo.svg";

const NavBar = ({ loggedInUser, cartItems, setSearchQuery, handleLogout, setShowLogin, setShowCart, cartLength, removeFromCart, addToCart }) => {
    return (
